...
<input class="w3-input w3-border" type="text" name = "dname">
</p><p>      
...
<input class="w3-input w3-border" type="text" name = "kinds" >
</p>    
</p><p>      
...
<input class="w3-input w3-border" type="text" name = "local" >
</p>
</p><p>      
